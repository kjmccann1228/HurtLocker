 ...
 */
public class GroceryFormatterTest
{
    @Test
    public void setItemCountTester()
    {
        ...
        groceryFormatter.setItemCount();
        Integer actual = groceryFormatter.itemCounts.get("Cookies");
        Integer expected = 7;
        assertEquals(expected, actual);
    }

    @Test
    public void setItemPriceCountTester()
    {
        ...
        groceryFormatter.getGroceryCategories();
        groceryFormatter.printPriceCounts();
    }
}
